...
>
> **We'd love your feedback!** Please share any suggestions, bug reports, feature requests, or general thoughts by [filing an issue](https://www.github.com/stainless-sdks/nps-csharp/issues/new).
...
```bash
git clone git@github.com:stainless-sdks/nps-csharp.git
dotnet add reference nps-csharp/src/Nps
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/nps-csharp/issues) with questions, bugs, or suggestions.
