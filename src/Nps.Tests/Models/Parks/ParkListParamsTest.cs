...
public class ParkListParamsTest : TestBase
{
    [Fact]
    ...
    public void Url_Works()
    {
        ...
        Assert.Equal(
            new Uri(
                "https://developer.nps.gov/api/v1/parks?limit=0&parkCode=string&q=q&sort=string&start=0&stateCode=string&api_key=My+API+Key"
            ),
            url
        );
    }
