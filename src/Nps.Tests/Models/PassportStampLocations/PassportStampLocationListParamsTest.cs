...
public class PassportStampLocationListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new PassportStampLocationListParams
        {
            Limit = 0,
            ParkCode = ["string"],
            Q = "q",
    ...
    {
        PassportStampLocationListParams parameters = new()
        {
            Limit = 0,
            ParkCode = ["string"],
            Q = "q",
        ...
        Assert.Equal(
            new Uri(
                "https://developer.nps.gov/api/v1/passportstamplocations?limit=0&parkCode=string&q=q&start=0&stateCode=string&api_key=My+API+Key"
            ),
            url
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        PassportStampLocationListParams copied = new(parameters);
