...
/// <summary>
/// A client for interacting with the National Parks API REST API.
///
...
/// </summary>
public interface INationalParksApiClient : IDisposable
{
    ...
    /// for each method.
    /// </summary>
    INationalParksApiClientWithRawResponse WithRawResponse { get; }
    ...
    /// </summary>
    INationalParksApiClient WithOptions(Func<ClientOptions, ClientOptions> modifier);
...
/// <summary>
/// A view of <see cref="INationalParksApiClient"/> that provides access to raw HTTP responses for each method.
/// </summary>
public interface INationalParksApiClientWithRawResponse : IDisposable
{
    /// <inheritdoc cref="ClientOptions.HttpClient" />
    HttpClient HttpClient { get; init; }
    ...
    /// <para>The original service is not modified.</para>
    /// </summary>
    INationalParksApiClientWithRawResponse WithOptions(Func<ClientOptions, ClientOptions> modifier);
    ...
    /// <summary>
    /// Sends a request to the National Parks API REST API.
    /// </summary>
