...
/// </summary>
public record class PersonListParams : ParamsBase
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PersonListParams(PersonListParams personListParams)
        : base(personListParams) { }
...
#pragma warning restore CS8618
    ...
    public static PersonListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(PersonListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/people")
        {
