...
) : IPage<AlertListResponse>
{
    /// <inheritdoc/>
    public IReadOnlyList<AlertListResponse> Items
    {
    ...
    /// <inheritdoc/>
    async Task<IPage<AlertListResponse>> IPage<AlertListResponse>.Next(
        CancellationToken cancellationToken
    ) => await this.Next(cancellationToken).ConfigureAwait(false);

    /// <inheritdoc cref="IPage{T}.Next"/>
    public async Task<AlertListPage> Next(CancellationToken cancellationToken = default)
    {
