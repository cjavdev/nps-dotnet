...
/// </summary>
public record class ArticleListParams : ParamsBase
{
    /// <summary>
    ...
    public ArticleListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ArticleListParams(ArticleListParams articleListParams)
        : base(articleListParams) { }
...
#pragma warning restore CS8618
    ...
    public static ArticleListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ArticleListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/articles")
        {
