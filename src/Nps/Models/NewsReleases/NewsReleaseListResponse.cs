...
public sealed record class Data : JsonModel
{
    ...
    {
        get { return this._rawData.GetNullableClass<string>("abstract"); }
        init
        {
            if (value == null)
            {
    ...
    public Image? Image
    {
        get { return this._rawData.GetNullableClass<Image>("image"); }
        init
        {
            if (value == null)
            {
    ...
    {
        get { return this._rawData.GetNullableStruct<ImmutableArray<RelatedOrg>>("relatedOrgs"); }
        init
        {
            if (value == null)
            {
    ...
    {
        get { return this._rawData.GetNullableStruct<DateTimeOffset>("releasedate"); }
        init
        {
            if (value == null)
            {
