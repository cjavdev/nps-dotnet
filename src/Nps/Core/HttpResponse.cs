    ...
    public async Task<T> Deserialize<T>(Threading::CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            return await JsonSerializer
                ...
                ?? throw new NationalParksInvalidDataException("Response cannot be null");
        }
...
public sealed class HttpResponse<T> : global::Nps.Core.HttpResponse
{
    ...
    internal HttpResponse(
        global::Nps.Core.HttpResponse response,
...
public sealed class StreamingHttpResponse<T> : global::Nps.Core.HttpResponse
{
